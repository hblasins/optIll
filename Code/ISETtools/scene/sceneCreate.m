...
% sceneInterpolateW.
% 
% There is a great deal of work going on (2015) concerning the extension of
% scene models to 3D scenes.  Contact us if this is important to you and
...
switch sceneName
    ...
    case {'mackay','rayimage','ringsrays'}
        ...
        % radF = 24; imSize = 512;
        % vcAddObject(sceneCreate('mackay',radF,imSize));
        % sceneWindow();
        radFreq = 8; sz = 256;
